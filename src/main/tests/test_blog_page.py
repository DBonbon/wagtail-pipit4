...
from ..factories.blog_page import BlogPageFactory
from ..pages import BlogPageSerializer
...
class BlogPageTest(WagtailPageTests):
    ...
    def test_get_serializer_class(self):
        page = BlogPageFactory.create(title="Blog", parent=self.root_page)
        self.assertEqual(page.get_serializer_class(), BlogPageSerializer)
    ...
    def test_to_react_representation(self):
        ...
        self.assertEqual("Blog", data["component_props"]["title"])
